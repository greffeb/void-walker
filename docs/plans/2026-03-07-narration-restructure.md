...
**Architecture:** 8 tasks covering types → engine → narration → store → UI. Each task is testable in isolation. Design doc: `docs/plans/2026-03-07-narration-restructure-design.md`. Tests are written before implementation (TDD).
